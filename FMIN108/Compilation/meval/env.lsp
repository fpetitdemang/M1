...
;- pour les variables et constantes, un élément de l'environnement est un triplet ( nom de variable - valeur - suffixe 'const si c'est une constante)
;- pour les fonctions et macros, un élément de l'environnement est un quintuplet ( nom de fonction - ( liste des noms des paramètres - corps ) - environnement d'évaluation - drapeau en binaire)
;- le drapeau sur 2 bits sert à caractériser la fonction: le bit 0 est vrai si c'est une macro, le bit 1 est vrai si la fonction est compilée
...
; * maintenant qu'on a mdefun, on définit à nouveau setglobalfunction pour que tout soit méta-défini
...
; ***** de meme, définition de la fonction MDEFMACRO *****
...
; ***** accesseurs sur les éléments des environnements de variables et de fonctions *****
...
; * modifie la 1ère variable locale trouvée en parcourant les associations locales dans l'ordre chronologique inverse de leur création, ou à défaut, la modifie ou la crée dans les associations globales
...
; * renvoie la valeur de la fonction dans la forme sous laquelle elle est stoquée dans l'environnement
...
; * renvoie la valeur de la macro sous la forme dans laquelle elle est définie dans l'environnement
...
; ***** accesseurs sur les champs des éléments de l'environnement de fonctions *****
...
; * teste si une fonction ou macro est compilée

(mdefun fcompiledp (fv) (if fv (>= (fdrap fv) 2)))

; * marque une valeur fonctionnelle est compilée
...
; * marque une macro comme compilée
...
; * teste si une macro est compilée
...
; * teste si une fonction est compilée
...
; * crée un élément de l'environnement de variables à partir d'un nom de variable et de sa valeur
